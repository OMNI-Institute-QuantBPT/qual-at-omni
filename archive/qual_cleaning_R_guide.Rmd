---
title: "Cleaning Qualitative Data in R Guide"
subtitle: ""
author: "Hannah"
...
start working with qualitative data at OMNI. Whether we’re working with
...
analysis. Cleaning is not just about tidying up; it’s about making
...
during this process. These decisions are guided by the project’s goals,
...
guided by the project’s research questions or evaluation goals. Having a
...
sensitive content. A data analysis plan This outlines the team’s
...
data. However, you may need to create a codebook if one doesn’t
exist—feel free to reach out to the QualBPT (or whichever team you want
...
confidentiality, and meet the project’s goals.

Finally, whether you’re writing code for qualitative data cleaning or
...
Make it easy on future OMNI-ites—and on your future self!

## When are data clean?

✅ What Does It Mean to Have "Clean" Qualitative Data? For there to be
project tasks that direct OMNI-ites to ‘clean qualitative data,’ and a
guide to help in doing so, there should also be a shared understanding
of what it means for qualitative data to be clean.

📝 Definition of Clean Qualitative Data: At OMNI, qualitative data are
...
free of irrelevant clutter (like transcription artifacts) 🎯 What Makes
...
Each speaker’s text is grouped logically into segments, preserving
...
necessary, following OMNI’s confidentiality guidelines. Questions Are
...
(e.g., repeated words, filler words, auto-captions like “[inaudible]”)
...
“Pre-implementation,” “Post-implementation”), they are included in the
data structure. 💡 How Do We Know When Qualitative Data Are Clean? Here
...
decisions. For example, if the team plans to do thematic coding, they’ll
...
Each speaker’s contributions should be clearly labeled, consistently
formatted, and grouped logically. Are responses to specific questions
clearly identifiable?

If interviews or focus groups follow a semi-structured guide, it’s
...
Time stamps, filler words, and transcription errors that don’t add value
...
accuracy and completeness. ✨ Common Issues to Discuss Early in the
...
discussion theme or section of the focus group? 🚀 In the Following
Sections... We’ll see how these fundamentals—like tidy qualitative data,
pipes, and regular expressions—play out in real-world cleaning tasks,
such as:
...
software (Dedoose, NVivo, etc.) ✅ Quick Summary of "Clean Qualitative
...
📝 How to Report the Results of Qualitative Data Cleaning at OMNI
...
Project leads understand what’s been done and why. Provide documentation
...
and reporting. Qualitative data cleaning produces results—changes to the
text or data structure—that should be documented in a clear, shareable
data cleaning report.

📋 What to Include in a Qualitative Data Cleaning Report 1. Summary of
...
Were job titles generalized (e.g., “CEO” changed to “senior leader”)?
...
“at Boulder Community Hospital” becomes “at [hospital]”). Redacted job
...
Were timestamps deleted? Were filler words (e.g., “um,” “uh”) removed?
...
format [hh:mm:ss]. Deleted common filler words (“um,” “uh”) unless they
contributed to participant meaning or tone. Reviewed and corrected
auto-transcription errors (e.g., “Dodoose” corrected to “Dedoose”).
...
Session name (e.g., “Educators” vs. “Public Health Professionals”)
Discussion section (e.g., “Challenges,” “Recommendations”) Participant
...
“Head Nurse” changed to “Medical Staff”).
...
💡 Tips for Reporting Qualitative Data Cleaning Be Transparent Even
small decisions (e.g., standardizing speaker labels) can have big
implications during analysis. If you’re unsure whether to document
...
changes with full knowledge of the process 🖼️ Example Summary Table in a
...
📝 Relevant Terminology for Qualitative Data Cleaning in R 🔧 Data
...
🗂️ Qualitative Metadata & Labeling Terms Speaker Label An identifier
...
group a participant was part of (e.g., "Session 1 – Educators").
...
✂️ Data Cleaning & Transformation Terms Anonymization /
...
into smaller parts—words, sentences, or phrases—typically for text
...
🏷️ Text Cleaning Terms Timestamps Time markers in transcripts (e.g.,
...
Inaudibles / Transcription Errors Markers like “[inaudible]” or machine
...
clean_transcript <- function(file_path,
  ...
  # ================================
  # ✅ 1. Load transcript based on file_type
  # ================================
  if (file_type == ".docx") {
  ...
  # ================================
  # ✅ 2. Classify speaker: interviewer vs participant
  # ================================
  df <- df %>%
    mutate(
      speaker = case_when(
  ...
  # ================================
  # ✅ 3. Extract participant & interviewer names
  # ================================
  ...
  # ================================
  # ✅ 5. Create speaker segments BEFORE detecting questions
  # ================================
  df <- df %>%
    arrange(line) %>%
  ...
  # ================================
  # ✅ 6. Detect interviewer questions
  # ================================
  df <- df %>%
    mutate(
      question = if_else(
  ...
  # ================================
  # ✅ 7. Remove text before first question
  # ================================
  ...
  # ================================
  # ✅ 9. Remove interviewer lines AFTER section labels assigned
  # ================================
  df <- df %>%
