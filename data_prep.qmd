...
sensitive content. 
- A **[data analysis plan](https://omniinstitute.atlassian.net/wiki/spaces/Quant/pages/375226966/Guide+for+data+analysis+plans)**. This outlines the team’s
...
- For there to be project tasks that direct Omni-ites to ‘clean qualitative data,’ and a
...
- Confidential information (e.g., agency names, job titles, organizations) is anonymized where necessary, following Omni’s confidentiality guidelines. 
